...
const Cards = () => {
  ...
  return (
    <div className="flex flex-wrap place-content-evenly px-3 mt-2">
      {loading ? (
          ...
          return (
            <>
              <Link to={`/details/${e.id}`}>
                ...
                >
                  <img className="h-60 md:h-72 w-72" src={e.image} alt="no" />
                  <h1>{e.title}</h1>
                  ...
                  <h1>
                    ...
                    <br />
                    <span className="text-gray-500">Click on image</span>
                  </h1>
                </div>
              </Link>
            </>
